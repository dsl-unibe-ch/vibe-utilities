...
#------------------------
#SBATCH --job-name="vibe-applications autobuild"
...
#SBATCH -o /storage/research/dsl_vibe_rs/environments/vibe-applications/logs/slurm/output_%j.txt
#SBATCH -e /storage/research/dsl_vibe_rs/environments/vibe-applications/logs/slurm/error_%j.txt
