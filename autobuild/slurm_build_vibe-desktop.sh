...
#------------------------
#SBATCH --job-name="vibe-desktop autobuild"
...
#SBATCH -o /storage/research/dsl_vibe_rs/environments/vibe-desktop/logs/slurm/output_%j.txt
#SBATCH -e /storage/research/dsl_vibe_rs/environments/vibe-desktop/logs/slurm/error_%j.txt

# script vars
STAGE="vibe-desktop"
VIBE_HOME="/storage/research/dsl_vibe_rs"
CONFIGFILE="$VIBE_HOME/private/buildscripts/configs/config_vibe-desktop.conf"
